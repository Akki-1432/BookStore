				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<div class="row">
						<table class="data-table stripe hover nowrap">
							...
							<tbody>
						<?php
							$query = "select * from subcategory,category where subcategory.cat_id= category.cat_id ";
								...
								<tr>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="view_subcat.php?viewid=<?php echo $result['subcat_id'] ?>"><i class="fa fa-eye"></i> View</a>
												<a class="dropdown-item" href="edit_subcat.php?editid=<?php echo $result['subcat_id'] ?>"><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item" href="del_subcat.php?delid=<?php echo $result['subcat_id'] ?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
