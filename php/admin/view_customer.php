						...
						<table class="data-table stripe hover nowrap">
							<thead>
								<tr>
									...
									<th class="table-plus datatable-nosort">c name</th>
									<th class="table-plus datatable-nosort">c mobile</th>
									<th class="table-plus datatable-nosort">c address</th>
									<th class="table-plus datatable-nosort">c email</th>
									<th class="table-plus datatable-nosort">password</th>
									<th class="table-plus datatable-nosort">is active</th>
									<th>Create date</th>
								...
								<tr>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="view_customer.php?viewid=<?php echo $result['c_id'] ?>"><i class="fa fa-eye"></i> View</a>
												<a class="dropdown-item" href="edit_customer.php?editid=<?php echo $result['c_id'] ?>"><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item" href="del_customer.php?delid=<?php echo $result['c_id'] ?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
