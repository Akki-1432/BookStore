								...
								<tr>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="view_order.php?viewid=<?php echo $result['order_id'] ?>"><i class="fa fa-eye"></i> View</a>
												<a class="dropdown-item" href="edit_order.php?editid=<?php echo $result['order_id'] ?>"><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item" href="del_order.php?delid=<?php echo $result['order_id'] ?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
