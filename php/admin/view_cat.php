								...
								<tr>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="view_cat.php?viewid=<?php echo $result['cat_id'] ?>"><i class="fa fa-eye"></i> View</a>
												<a class="dropdown-item" href="edit_cat.php?editid=<?php echo $result['cat_id'] ?>"><i class="fa fa-pencil"></i> Edit</a>
												<a class="dropdown-item" href="del_cat.php?delid=<?php echo $result['cat_id']?>"><i class="fa fa-trash"></i> Delete</a>
											</div>
										</div>
									</td>
								</tr>
