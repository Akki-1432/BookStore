				...
				<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
					...
					<form method="POST" action="">
						<div class="form-group row">
							<input type="text" name="subcat_id" value="<?php echo $result['subcat_id'] ?>" hidden>
							<label class="col-sm-12 col-md-2 col-form-label">Subcategory Name</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" value="<?php echo $result['subcat_name'] ?>" name="subcat_name" type="text" placeholder="Johnny Brown">
							</div>
						</div>
						<div class="form-group row">
...
<?php 
 	...
 	{
 		extract($_POST);
 		$query = "UPDATE subcategory SET subcat_name ='$subcat_name' WHERE subcat_id = '$subcat_id'";
 		$t = mysqli_query($conn,$query);
